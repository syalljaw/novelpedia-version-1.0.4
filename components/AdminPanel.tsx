              ...
              <div className="bg-amber-50 border border-amber-100 p-5 rounded-xl flex flex-col gap-4 shadow-sm">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex bg-slate-200 p-1 rounded-lg shrink-0">
                    <button className="px-4 py-2 text-[10px] font-black uppercase rounded-md bg-amber-500 text-slate-950 shadow-sm transition-all">ON</button>
                    <button className="px-4 py-2 text-[10px] font-black uppercase rounded-md text-slate-500 hover:text-slate-700 transition-all cursor-pointer">OFF</button>
                  </div>
                </div>
                ...
                <div className="border-t border-amber-200/60 pt-4">
                   ...
                   <select className="w-full bg-white border border-slate-200 rounded-xl p-3 text-xs font-bold outline-none text-slate-700 focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all shadow-sm">
                ...
                <button 
                  ...
                  onClick={() => alert("Pengaturan Iklan berhasil disimpan!")}
                >
